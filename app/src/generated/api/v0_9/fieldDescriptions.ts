...
export const fieldDescriptions = {
  "AutoCalibrateAwbRequest": {
    "eps": "Maximum delta between gain values to consider them stable.",
    "stable_frames": "Consecutive frames that must meet the stability tolerance.",
    "timeout_s": "Maximum time budget for the calibration loop in seconds.",
    "warmup_frames": "Number of frames to discard before reading AWB metadata."
  },
  ...
  "DiskUsage": {
    "free": "Free bytes remaining on the filesystem.",
    "total": "Total bytes available on the filesystem.",
    "used": "Bytes currently used (total - free)."
  },
  "EndstopConfig": {
    "active_high": "Useful for normally closed switches",
  ...
  "MotorConfig": {
    ...
    "home_angle": "Angle for home position in degrees.",
  ...
  "SoftwareInfoResponse": {
    "firmware_version": "Currently running firmware version string.",
    "last_shutdown_was_unclean": "Indicates whether the previous shutdown finished cleanly.",
    "model": "Scanner model identifier, if configured.",
    "projects_disk": "Disk usage snapshot for the projects directory filesystem.",
    "runtime_dir": "Absolute path used for runtime state files.",
    "runtime_disk": "Disk usage snapshot for the runtime directory filesystem.",
