 ...
 * LightStatusResponse: A response object containing the status of the light after the toggle operation
 */
export const pwmLight = <ThrowOnError extends boolean = false>(options: Options<PwmLightData, ThrowOnError>) => (options.client ?? client).put<PwmLightResponses, PwmLightErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * Check For Updates
 */
export const checkForUpdates = <ThrowOnError extends boolean = false>(options?: Options<CheckForUpdatesData, ThrowOnError>) => (options?.client ?? client).post<CheckForUpdatesResponses, CheckForUpdatesErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * Apply Updates
 */
export const applyUpdates = <ThrowOnError extends boolean = false>(options?: Options<ApplyUpdatesData, ThrowOnError>) => (options?.client ?? client).post<ApplyUpdatesResponses, ApplyUpdatesErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * Repair Openscan3
 */
export const repairOpenscan3 = <ThrowOnError extends boolean = false>(options?: Options<RepairOpenscan3Data, ThrowOnError>) => (options?.client ?? client).post<RepairOpenscan3Responses, RepairOpenscan3Errors, ThrowOnError>({
    responseType: 'json',
 ...
 */
export const addScan = <ThrowOnError extends boolean = false>(options: Options<AddScanData, ThrowOnError>) => (options.client ?? client).post<AddScanResponses, AddScanErrors, ThrowOnError>({
    responseType: 'json',
 ...
 */
export const wakeupDevice = <ThrowOnError extends boolean = false>(options?: Options<WakeupDeviceData, ThrowOnError>) => (options?.client ?? client).post<WakeupDeviceResponses, WakeupDeviceErrors, ThrowOnError>({
    responseType: 'json',
    url: '/device/wakeup',
    ...options
});
