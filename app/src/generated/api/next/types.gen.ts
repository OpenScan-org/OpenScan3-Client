 ...
 */
export type ExternalTriggerPoint = {
    /**
     * Execution Step
     */
...
/**
 * ExternalTriggerRunCreateRequest
 */
export type ExternalTriggerRunCreateRequest = {
    /**
     * Label
     */
    label?: string | null;
 ...
 */
export type ExternalTriggerRunPath = {
    /**
     * Task Id
     */
    task_id: string;
     ...
     * Points
     */
    points?: Array<ExternalTriggerPoint>;
};

/**
 * ExternalTriggerRunSettings
 */
export type ExternalTriggerRunSettings = {
    /**
     * Scanning path generator for the external trigger run.
     */
     ...
     *
     * Path optimization algorithm to use when optimize_path is enabled.
     */
    optimization_algorithm?: string;
    /**
     * Trigger Name
     *
     * Name of the configured trigger device to fire at each scan point.
     */
    trigger_name: string;
    /**
     * Pre Trigger Delay Ms
     *
     * Delay after reaching the scan position and before asserting the trigger.
     */
    pre_trigger_delay_ms?: number;
    /**
     * Post Trigger Delay Ms
     *
     * Delay after releasing the trigger before the next scan step starts.
     */
    post_trigger_delay_ms?: number;
};
